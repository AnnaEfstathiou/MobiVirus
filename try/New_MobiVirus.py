...
## List to stote the infector (c) and the infected (j) ##
## This list keeps track of the infector (c) and the infected (j) to avoid that 2 infection will happen from the same infector (c). ##
c_j = [] 
#%%
